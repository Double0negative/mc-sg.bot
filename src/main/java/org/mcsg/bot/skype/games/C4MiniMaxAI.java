...
public class C4MiniMaxAI extends Connect4AI {
    ...
    private static final int[][] SCORE = new int[][] { new int[] { 1, 2, 3, 4, 3, 2, 1 },
            new int[] { 2, 3, 4, 5, 4, 3, 2 }, new int[] { 3, 4, 5, 6, 5, 4, 3 }, new int[] { 3, 4, 5, 6, 5, 4, 3 },
    ...
    public boolean makeMove() {
        ...
        try {
            return game.makeMove(side, move); // since the Skype API doesn't
                                              // detect self-message for some
                                              // reason
